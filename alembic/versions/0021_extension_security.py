...
def upgrade():
    ...
    if "extension_certificates" in existing_tables and "extension_signing_certificates" not in existing_tables:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer, primary_key=True, index=True),
        sa.Column("certificate_id", sa.String(255), nullable=False, unique=True, index=True),
        sa.Column("extension_id", sa.String(255), nullable=False, index=True),
        ...
        sa.Column("revocation_status", sa.String(50), nullable=False, default="unknown"),
