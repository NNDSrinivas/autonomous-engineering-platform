...
class CommitEngine:
    ...
    async def create_branch(self, branch_name: str, base_branch: str = "main") -> BranchInfo:
        """
    ...
    def _build_commit_message(
        ...
        if not any(summary.startswith(prefix) for prefix in ["fix:", "feat:", "docs:", "style:", "refactor:", "test:"]):
