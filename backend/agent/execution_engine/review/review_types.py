...
class FixResult(BaseModel):
    ...
    reply_message: Optional[str] = Field(
        default=None, description="Reply message posted"
    )
    ...
    requires_approval: bool = Field(
        default=True, description="Whether fix needs approval"
    )
...
class AutoFixSummary(BaseModel):
    ...
    fixes_requiring_approval: int = Field(
        description="Number of fixes awaiting approval"
    )
