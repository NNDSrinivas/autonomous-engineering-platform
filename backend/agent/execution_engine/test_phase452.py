...
from backend.agent.execution_engine.ci import (
    CIEvent, CIProvider, CILogFetcher, FailureClassifier, 
    FailureMapper, CIRepairOrchestrator,
    RepairConfiguration, CIIntegrationContext
)
...
2024-12-24T10:30:47.300Z BUILD FAILED
    ...
    repair_plan = mapper.map_failure_to_repair_plan(
