...
class ApprovalEngine:
    ...
    def evaluate_action(
        ...
        try:
            ...
            risk_score, risk_reasons = self.risk_scorer.calculate_risk(action_type, context)
            ...
            if self._is_action_blocked(action_type, policy, context):
                ...
                return decision, risk_score, risk_reasons + ["Action blocked by policy"], None
            ...
            return DecisionType.APPROVAL, 1.0, ["Error in evaluation - requires manual review"], None
    ...
    def approve_request(
        ...
        # Update database
        self.policy_store.update_approval_status(approval_id, "approved", approver_id, comment)
    ...
    def reject_request(
        ...
        # Update database
        self.policy_store.update_approval_status(approval_id, "rejected", approver_id, comment)
