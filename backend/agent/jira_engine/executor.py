...
async def complete_jira_work(
    user_id: str, issue_id: str, summary: Optional[str] = None
) -> Dict[str, Any]:
    """
...
async def add_jira_comment(user_id: str, issue_id: str, comment: str) -> Dict[str, Any]:
    """
...
async def transition_jira(
    user_id: str, issue_id: str, target_status: str, comment: Optional[str] = None
) -> Dict[str, Any]:
    """
...
async def update_jira_description(
    user_id: str, issue_id: str, new_description: str
) -> Dict[str, Any]:
    """
...
async def suggest_story_points(
    issue: Dict[str, Any], enriched_context: Dict[str, Any]
) -> int:
    """
