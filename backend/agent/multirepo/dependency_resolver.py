...
class DependencyResolver:
    ...
    def __init__(self):
        ...
        logger.info(
            "DependencyResolver initialized for multi-language dependency analysis"
        )

    def resolve_dependencies(
        self, repo_path: str, repo_name: str, include_transitive: bool = False
    ) -> DependencyGraph:
        """
        ...
        direct_deps = [
            d for d in dependencies if d.dependency_type == DependencyType.DIRECT
        ]
    ...
    def _calculate_health_score(self, dependencies: List[Dependency]) -> float:
        ...
        internal_ratio = sum(1 for d in dependencies if d.is_internal) / len(
            dependencies
        )
