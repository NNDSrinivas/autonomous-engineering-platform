...
class SelfHealingEngine:
    ...
    async def _complete_session(
        ...
        if emit_event:
            await emit_event(
                f"navi.selfHealing.{status.value}",
                {
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self.stats,
            ...
            "active_sessions": len(
                [s for s in self.active_sessions.values() if not s.is_complete]
            ),
        }
