...
async def edit_file(user_id: str, path: str, new_content: str) -> Dict[str, Any]:
    ...
    try:
        ...
        change_indicator = (
            "+" if new_lines > old_lines else "-" if new_lines < old_lines else "="
        )
