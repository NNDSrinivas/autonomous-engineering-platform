...
SAFE_COMMANDS = {
    # Package managers
    "npm", "yarn", "pnpm", "pip", "pip3", "poetry", "pipenv",
    "cargo", "go", "mvn", "gradle", "composer", "bundle",
    
    # Testing
    "pytest", "jest", "mocha", "vitest", "go test", "cargo test",
    
    # Build tools
    "make", "cmake", "tsc", "webpack", "vite", "esbuild",
    ...
    # Info commands
    "node", "python", "python3", "java", "go version", "cargo --version"
}
