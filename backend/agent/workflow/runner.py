...
class WorkflowRunner:
    ...
    async def continue_workflow(self, issue_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Execute next step
            context = {"user_id": self.user_id, "workspace_root": self.workspace_root}
...
async def continue_autonomous_task(
    user_id: str, issue_id: str, workspace_root: str
) -> Dict[str, Any]:
    """
...
async def approve_autonomous_task(
    user_id: str, issue_id: str, workspace_root: str
) -> Dict[str, Any]:
    """
...
async def cancel_autonomous_task(
    user_id: str, issue_id: str, workspace_root: str, reason: Optional[str] = None
) -> Dict[str, Any]:
    """
