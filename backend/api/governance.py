...
def get_organization_policies(
    request: Request, policy_store: AutonomyPolicyStore = Depends(get_policy_store)
) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"policies": policy_list, "total": len(policy_list)}
...
def get_audit_trail(
    ...
    try:
        ...
        return {"audit_entries": audit_list, "total": len(audit_list)}
...
def check_rollback(
    ...
    try:
        ...
        return {"can_rollback": can_rollback, "reason": reason, "action_id": action_id}
