...
class InitiativeCreateRequest(BaseModel):
    ...
    config: Optional[Dict[str, Any]] = Field(
        None, description="Initiative configuration"
    )
...
async def create_initiative(
    ...
    try:
        ...
        config = InitiativeConfig(
            ...
            auto_checkpoint_interval_minutes=config_dict.get(
...
async def list_initiatives(
    ...
    try:
        ...
        if owner_filter:
            active_initiatives = [
                init for init in active_initiatives if init.get("owner") == owner_filter
            ]
...
async def execute_initiative(
    ...
    try:
        ...
        background_tasks.add_task(orchestrator.execute_initiative, initiative_id)
...
async def list_checkpoints(
    ...
    try:
        ...
        checkpoints = checkpoint_engine.list_checkpoints(
            initiative_id=initiative_id, limit=limit
        )
