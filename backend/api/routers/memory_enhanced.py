...
async def save_conversation(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Save conversation failed: {str(e)}")
...
async def get_recent_conversations(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Get conversations failed: {str(e)}")
