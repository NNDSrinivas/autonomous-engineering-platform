...
async def get_available_models(
    ...
    try:
        ...
        default_model = f"{smart_candidates_list[0].provider}/{smart_candidates_list[0].name}" if smart_candidates_list else "openai/gpt-4o-mini"
        smart_candidates = smart_auto_candidates()
        default_model = smart_candidates[0].model_id if smart_candidates else "gpt-4o-mini"
