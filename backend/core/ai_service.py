...
class AIService:
    ...
    async def ask_question(self, question: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
...
{{
    ...
    "performance_notes": ["performance optimization suggestions"]
                ...
                messages = [
                    {"role": "system", "content": "You are an expert code reviewer. Analyze code thoroughly and provide constructive feedback."},
                ...
                mock_analysis = {
                    "python": {
                        "issues": ["Recursive implementation may cause stack overflow for large inputs"],
                        "suggestions": ["Consider using dynamic programming or iterative approach", "Add input validation"],
                        "complexity_score": 8,
                    ...
                    "javascript": {
                        ...
                        "suggestions": ["Add try-catch blocks", "Use const/let instead of var"],
                        "complexity_score": 5,
                ...
                analysis = mock_analysis.get(language.lower(), {
                    "issues": ["Language-specific analysis not available in demo mode"],
                    "suggestions": ["Enable AI features with OpenAI API key for detailed analysis"],
                    "complexity_score": 5,
