...
# Example: Matches "ENG-123" in "jira.com/browse/ENG-123" or "ENG-123-hotfix".
# Lookahead allows end-of-string or non-alphanumeric continuation (hyphens allowed after).
