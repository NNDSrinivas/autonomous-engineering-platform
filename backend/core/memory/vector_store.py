...
class VectorStore:
    ...
    def __init__(self, persist_dir: Optional[str] = None):
        ...
        if CHROMA_AVAILABLE:
            try:
                ...
                logger.info("ChromaDB initialized for engineering platform", path=self.persist_dir)
    ...
    async def add_knowledge(
        ...
        try:
            ...
            logger.info("Added knowledge to vector store", 
                       type=knowledge_type, project=project, id=entry_id)
            return entry_id
            ...
            try:
                ...
                if search_results and search_results['documents']:
                    for i, doc in enumerate(search_results['documents'][0]):
                        ...
                        doc_id = search_results['ids'][0][i] if search_results['ids'] else f"unknown_{i}"
            ...
            try:
                ...
                if search_results and search_results['documents']:
                    for i, doc in enumerate(search_results['documents']):
                        ...
                        doc_id = search_results['ids'][i] if search_results['ids'] else f"recent_{i}"
