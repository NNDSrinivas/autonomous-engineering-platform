...
class OnboardingFlow:
    ...
    def is_completed(self) -> bool:
        ...
        return all(
            step.status == OnboardingStepStatus.COMPLETED or 
            (not step.required and step.status == OnboardingStepStatus.SKIPPED)
    ...
    def progress_percentage(self) -> float:
        ...
        completed_weight = sum(
            step.completion_percentage for step in self.steps
        )
...
class OnboardingFlowBuilder:
    ...
    def build_enterprise_flow(self, org_config: OrganizationConfig) -> OnboardingFlow:
        ...
        flow.steps.append(OnboardingStep(
            id="org_setup",
...
class IntegrationConnector:
    ...
    async def get_integration_info(self, integration: IntegrationType) -> Dict[str, Any]:
    ...
    async def initiate_oauth_flow(self, integration: IntegrationType) -> Dict[str, str]:
        ...
        redirect_uri = f"https://your-domain.com/api/onboarding/oauth/callback/{integration.value}"
    ...
    async def complete_oauth_flow(self, integration: IntegrationType,
                                 auth_code: str, state: str) -> bool:
...
class OnboardingService:
    ...
    async def complete_step(self, step_id: str, step_data: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def _complete_integration_setup(self, step: OnboardingStep, data: Dict[str, Any]):
    ...
    async def _complete_repository_selection(self, step: OnboardingStep, data: Dict[str, Any]):
    ...
    async def get_integration_options(self) -> List[Dict[str, Any]]:
        ...
        for integration_type in IntegrationType:
            info = await self.integration_connector.get_integration_info(integration_type)
