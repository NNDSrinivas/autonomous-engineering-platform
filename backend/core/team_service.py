...
class TeamService:
    ...
    async def search_team_context(self, query: str, project_id: Optional[str] = None, limit: int = 5) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for result in results:
                formatted_results.append({
                    ...
                    "relevant_sections": self._extract_relevant_sections(result.get("content", ""), query)
                })
        ...
        try:
            ...
            analytics = {
                "knowledge_base": {
                    ...
                    "categories": ["api-design", "code-review", "testing", "deployment", "performance"],
                    "top_contributors": ["team-lead", "senior-dev", "qa-lead", "devops-engineer"],
                    "recent_additions": 0
                },
                "search_patterns": {
