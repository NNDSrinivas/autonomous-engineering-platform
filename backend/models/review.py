...
class ReviewIssue(BaseModel):
    ...
    fix_patch: Optional[str] = Field(None, description="Auto-fix patch in unified diff format")
    can_auto_fix: bool = Field(default=False, description="Whether this issue can be auto-fixed")
