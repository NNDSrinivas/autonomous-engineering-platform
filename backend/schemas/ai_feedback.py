...
class FeedbackSubmission(BaseModel):
    ...
    reason: Optional[str] = Field(
        None, 
        max_length=64,
        description="Feedback reason category"
    )
...
class FeedbackStats(BaseModel):
    ...
    rating_distribution: Dict[int, int] = Field(..., description="Rating counts by value")
    reason_distribution: Dict[str, int] = Field(..., description="Reason counts by category")
