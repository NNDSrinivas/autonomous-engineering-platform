...
class ASTService:
    ...
    async def extract_method(
        self, file_path: str, method_name: str, start_line: int, end_line: int
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "message": f"Extract method failed: {str(e)}"}
    ...
    async def rename_variable(
        ...
        try:
            ...
            return {"success": False, "message": f"Rename variable failed: {str(e)}"}

    async def move_class(
        self, source_file: str, target_file: str, class_name: str
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "message": f"Move class failed: {str(e)}"}

    async def add_imports(self, file_path: str, imports: List[str]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "message": f"Add imports failed: {str(e)}"}
    ...
    def _sync_extract_method(
        ...
        try:
            ...
            logger.info(
                f"Would extract method '{method_name}' from lines {start_line}-{end_line}"
            )
            ...
            return {"success": False, "message": f"Extract method exception: {str(e)}"}

    def _sync_rename_variable(
        self, file_path: str, old_name: str, new_name: str
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "message": f"Rename variable exception: {str(e)}"}

    def _sync_move_class(
        self, source_file: str, target_file: str, class_name: str
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(
                f"Would move class '{class_name}' from {source_file} to {target_file}"
            )
            ...
            return {"success": False, "message": f"Move class exception: {str(e)}"}
    ...
    def _sync_add_imports(self, file_path: str, imports: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            for import_stmt in imports:
                ...
                import_line = (
                    import_stmt if import_stmt.endswith("\n") else import_stmt + "\n"
                )
            ...
            if new_imports:
                ...
                return {"success": True, "message": "All imports already exist"}

        except Exception as e:
            return {"success": False, "message": f"Add imports exception: {str(e)}"}
