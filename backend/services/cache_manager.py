...
class CacheManager:
    ...
    def cache_intent_classification(
        self, message: str, user_id: str, result: Any
    ) -> None:
    ...
    def get_cached_intent_classification(
    ...
    def cache_context(
        self, context_key: str, context_data: Any, ttl: Optional[float] = None
    ) -> None:
