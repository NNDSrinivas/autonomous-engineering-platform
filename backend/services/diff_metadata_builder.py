...
class DiffMetadataBuilder:
    ...
    def build(self, base_lines: List[str], target_lines: List[str], file_path: str) -> Dict[str, Any]:
    ...
    def build_multi_file_metadata(self, file_diffs: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for file_diff in file_diffs:
            file_metadata = self.build(
                file_diff['base_lines'],
                file_diff['target_lines'], 
                file_diff['path']
            )
