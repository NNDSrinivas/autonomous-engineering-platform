...
class JiraWriteService:
    ...
    async def add_comment(
        self, issue_key: str, comment: str, dry_run: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    async def transition_issue(
        self, issue_key: str, transition_name: str, dry_run: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(
                f"JIRA API error during transition: {e.response.status_code} {e.response.text}"
            )
