...
class ThompsonSamplingBandit:
    ...
    async def _update_arm_stats(self, context_key: str, arm: str, success: bool) -> None:
...
class LearningService:
    ...
    async def get_learning_stats(self, org_key: str) -> Dict:
        ...
        contexts = [
            {"task_type": "codegen", "input_size_bucket": "small", "user_experience": "standard"},
            {"task_type": "codegen", "input_size_bucket": "medium", "user_experience": "standard"},
            {"task_type": "codegen", "input_size_bucket": "large", "user_experience": "standard"},
        ]
