...
class TestApplyFixAPI:
    ...
    def test_apply_fix_success(self, client):
        ...
        with patch('backend.services.auto_fix_service.AutoFixService.apply_fix') as mock_apply:
    ...
    def test_apply_fix_failure(self, client):
        ...
        payload = {
            ...
            "fixId": "fix_invalid_456"
        }
        
        with patch('backend.services.auto_fix_service.AutoFixService.apply_fix') as mock_apply:
            mock_apply.return_value = Mock(
                success=False,
                message="File not found: nonexistent/file.js"
            )
    ...
    def test_apply_batch_fixes(self, client):
        ...
        with patch('backend.services.auto_fix_service.AutoFixService.apply_batch_fixes') as mock_batch:
    ...
    def test_get_available_fixes(self, client):
        ...
        with patch('backend.services.review_service.ReviewService.review_files') as mock_review:
...
class TestReviewAPI:
    ...
    def test_review_working_tree(self, client):
        ...
        with patch('backend.services.review_service.ReviewService.review_working_tree') as mock_review:
            mock_review.return_value = {
                "total_files": 2,
                "files_with_issues": 1,
                "total_issues": 3,
...
class TestSmartModeAPI:
    ...
    def test_smart_review_assessment(self, client):
        ...
        with patch('backend.services.planner.smart_mode.SmartModePlanner.assess_risk') as mock_assess:
...
class TestDiffAPI:
    ...
    def test_apply_hunk(self, client):
        ...
        with patch('backend.services.diff_service.DiffService.apply_hunk') as mock_apply:
    ...
    def test_explain_hunk(self, client):
        ...
        with patch('backend.services.explanation_service.ExplanationService.explain_hunk') as mock_explain:
