...
class TestGitOperations:
    ...
    def test_git_status_detection(self, temp_git_repo):
        ...
        assert len(changes) >= 0  # Empty repo will have this file as untracked initially
...
"""
        ...
        # Simple diff
        added_lines = [line for line in new_version.split('\n') 
...
class TestUserApprovalWorkflow:
    ...
    def test_approval_timeout(self):
        ...
        is_expired = (current_time - approval_request["created_at"]) > approval_request["expires_in"]
