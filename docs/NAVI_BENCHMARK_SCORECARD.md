...
| semi_medium | Semi‑medium task | True | False | 8.82 | `python3 -m pytest backend/tests/test_navi_api_integration.py::TestCodeReviewEndpoints::test_review_working_tree_endpoint -q` |
| long | Long task | True | False | 7.2 | `python3 -m pytest backend/tests/test_navi_api_integration.py -q` |
