# NAVI Vision — Features & Capabilities

> This document captures the detailed design, architecture, and feature specifications for each major capability shipped in NAVI. It is the authoritative reference for product, engineering, and QA teams.

For the high-level roadmap see [README.md](../README.md). For future model research see [NAVI_MODEL_VISION.md](NAVI_MODEL_VISION.md).
