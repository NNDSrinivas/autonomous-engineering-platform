...
class TestCIFailureFixerExtension:
    ...
    def setup_method(self):
        ...
        self.manifest_data = {
            ...
            "author": "Navra Labs",
            "version": "1.0.0",
            "permissions": ["CI_ACCESS", "ANALYZE_PROJECT", "FIX_PROBLEMS", "WRITE_FILES"],
            "entry": "index.ts"
        }
...
export async function onInvoke(ctx) {
  ...
  return {
    ...
    def test_permission_enforcement(self):
        ...
        expected_permissions = ["CI_ACCESS", "ANALYZE_PROJECT", "FIX_PROBLEMS", "WRITE_FILES"]
    ...
    def test_ci_failure_analysis(self):
        ...
        failure_type = "DEPENDENCY" if "Cannot resolve dependency" in ci_logs else "UNKNOWN"
    ...
    def test_complete_verification_flow(self):
        ...
        verifier.verification_service = ExtensionVerificationService(self.signing_service)
        ...
        with pytest.raises(Exception, match="Administrator approval required|Extension blocked until approved"):
