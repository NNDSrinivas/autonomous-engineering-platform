...
const ModernChatInterface_1 = require("./ModernChatInterface");
class AgentHomeViewProvider {
    ...
    updateAuthenticationState(isAuthenticated, userProfile = null) {
    ...
    getHtmlContent(webview) {
        ...
        if (this._isAuthenticated) {
            return ModernChatInterface_1.ModernChatInterface.getHTML(webview, this._userProfile);
        }
        else {
...
<body>
    ...
    addMessageToChat(sender, message, actions) {
        if (this._view) {
...
AgentHomeViewProvider.viewType = 'aep.agentHomeView';
//# sourceMappingURL=AgentHomeViewProvider.js.map