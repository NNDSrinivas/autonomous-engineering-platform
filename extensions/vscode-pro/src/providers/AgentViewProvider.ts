...
export class AgentViewProvider implements vscode.WebviewViewProvider {
  ...
  resolveWebviewView(view: vscode.WebviewView) {
    ...
    view.webview.onDidReceiveMessage(msg => {
      switch (msg.t) {
        case 'signin': vscode.commands.executeCommand('aep.connect'); break;
        case 'signout': vscode.commands.executeCommand('aep.disconnect'); break;
        case 'start': vscode.commands.executeCommand('aep.ai.newSession'); break;
        case 'settings': vscode.commands.executeCommand('workbench.action.openSettings', '@ext:navralabs-dev.aep-professional-dev'); break;
      }
    });
  }
