...
export class AgentHomeViewProvider implements vscode.WebviewViewProvider {
    ...
    private getHtmlContent(webview: vscode.Webview): string {
        const toolkitUri = getUri(webview, this.ctx.extensionUri, ['node_modules', '@vscode', 'webview-ui-toolkit', 'dist', 'toolkit.js']);
...
<body>
  ...
  <script>
    ...
    private html(webview: vscode.Webview, toolkitUri: vscode.Uri) {
