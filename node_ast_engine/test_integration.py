...
class ASTEngine:
    ...
    def __init__(self, engine_path: str = "./node_ast_engine"):
        ...
        if not os.path.exists(self.node_executable):
            raise FileNotFoundError(f"AST engine not found at {self.node_executable}. Run 'npm run build' first.")
    ...
    def _run_transform(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if process.returncode != 0:
                error_result = json.loads(process.stderr) if process.stderr else {"error": "Unknown error"}
                return error_result
    ...
    def rename_symbol(self, file_path: str, code: str, old_name: str, new_name: str, scope: str = "global") -> Dict[str, Any]:
    ...
    def update_import(self, file_path: str, code: str, from_module: Optional[str] = None, to_module: Optional[str] = None,
                     add_imports: Optional[List[Dict[str, Any]]] = None, remove_imports: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    def extract_component(self, file_path: str, code: str, component_name: str, 
                         new_file_name: Optional[str] = None, export_type: str = "default") -> Dict[str, Any]:
    ...
    def convert_js_to_ts(self, file_path: str, code: str, add_type_annotations: bool = True, 
                        convert_require: bool = True) -> Dict[str, Any]:
