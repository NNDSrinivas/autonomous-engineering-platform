...
KNOWLEDGE_BASE = [
    {
        ...
        "metadata": {"category": "api-design", "project": "demo-project", "author": "team-lead"},
    ...
    },
    {
        ...
        "metadata": {"category": "code-review", "project": "demo-project", "author": "senior-dev"},
        "keywords": ["code", "review", "logic", "performance", "security", "maintainability"]
    },
    {
        ...
        "metadata": {"category": "testing", "project": "demo-project", "author": "qa-lead"},
    ...
    },
    {
        ...
        "metadata": {"category": "deployment", "project": "demo-project", "author": "devops-engineer"},
    ...
    },
    {
        ...
        "metadata": {"category": "performance", "project": "demo-project", "author": "performance-engineer"},
...
CODE_ANALYSIS_TEMPLATES = {
    "python": {
        "issues": ["Recursive implementation may cause stack overflow for large inputs", "No input validation"],
        "suggestions": ["Consider using dynamic programming or iterative approach", "Add input validation", "Consider using type hints"],
        "complexity_score": 7,
        "maintainability_score": 6,
        "security_concerns": ["No input sanitization", "Potential for denial of service with large inputs"],
        "performance_notes": ["O(2^n) time complexity - consider memoization", "Use iterative approach for better performance"]
    },
    "javascript": {
        "issues": ["No error handling", "Variable scope concerns", "Missing semicolons"],
        "suggestions": ["Add try-catch blocks", "Use const/let instead of var", "Add proper error handling"],
        "complexity_score": 5,
        "maintainability_score": 7,
        "security_concerns": ["Potential XSS if handling user input", "No input validation"],
        "performance_notes": ["Consider async/await for better performance", "Use efficient DOM manipulation"]
    },
    "java": {
        "issues": ["No null checks", "Missing exception handling", "Non-descriptive variable names"],
        "suggestions": ["Add null checks", "Use Optional for nullable values", "Improve variable naming"],
        "complexity_score": 6,
        "maintainability_score": 7,
        "security_concerns": ["No input validation", "Potential null pointer exceptions"],
        "performance_notes": ["Consider using StringBuilder for string concatenation", "Use appropriate data structures"]
    }
}
...
async def search_team_context(request: TeamContextRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        if request.project_id:
            results = [r for r in results if r.get('metadata', {}).get('project') == request.project_id]
    ...
    try:
        analytics = {
            "knowledge_base": {
                ...
                "top_contributors": list(set(item["metadata"]["author"] for item in KNOWLEDGE_BASE)),
                "recent_additions": 0
            },
            "search_patterns": {
                "popular_queries": ["API design", "testing", "deployment", "performance"],
