                    ...
                    try:
                        ...
                        if data.get("type") == "progress":
                            ...
                            if files:
                                ...
                                print(
                                    f"   ⭐ Quality Score: {sample.get('quality_score', 'N/A')}"
                                )
                                ...
                                if issues:
                                    issue = issues[0]
                                    print(
                                        f"   🚨 Sample Issue: {issue.get('message', 'N/A')}"
                                    )
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(
            "   ✅ Updated endpoint from /api/smart/review/stream to /api/navi/analyze-changes"
        )
